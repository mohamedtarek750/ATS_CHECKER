...
/**
 * Where somebody applies.
 *
 * It does one thing - takes a person's details and their CV - and tells them
 * nothing about how they will be assessed. It was briefly the site's front
 * page; the landing page now sits in front of it, so this is reached by
 * pressing Apply rather than by arriving.
 *
 * The job picker matters more than it looks. Without it a CV sent from here
 * has nowhere to go but the unassigned pile, so a recruiter who had just
 * opened a job would look at it and see no applicants.
 */
